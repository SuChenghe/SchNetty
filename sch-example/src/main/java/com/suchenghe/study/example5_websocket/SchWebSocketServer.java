 ...
 */
public class SchWebSocketServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(SchWebSocketServer.class);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            serverBootstrap.group(bossGroup,workerGroup)
                ...
                .childHandler(new SchWebSocketServerInitializer());
