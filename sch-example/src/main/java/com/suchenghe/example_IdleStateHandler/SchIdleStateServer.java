 ...
 */
public class SchIdleStateServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(SchIdleStateServer.class);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            LOGGER.info("SchServer服务端启动成功,port:{},for IdleStateHandler",61005);
